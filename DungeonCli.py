...
def gameover():
	...
	print(Style.BRIGHT + Fore.WHITE + "Maybe next time, you might be a bit more lucky...\n")
	time.sleep(5)
	clear()
	exit()
...
def randomEvent():
	...
	if len(events) > 0:
		...
		if selection == "store":
			CSDescription = CSDescription + " There is a store nearby, they might sell something useful..."
